...
def main():
	...
	train_ds = CoCo("/home/pranoy/datasets/coco2017", image_set="train", transform=train_transform)
	eval_ds = CoCo("/home/pranoy/datasets/coco2017", image_set="val", transform=eval_transform)
