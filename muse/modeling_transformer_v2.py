...
from .modeling_utils import ConfigMixin, ModelMixin, TransformerAdapterMixin
...
class MaskGiTUViT_v2(ModelMixin, ConfigMixin, TransformerAdapterMixin):
    ...
    def forward(
        ...
        if low_res_input_ids is not None:
            ...
            print(low_res_input_ids.shape, encoder_hidden_states.shape, low_res_hidden_states.shape)
    ...
    def generate2(
        ...
        for step in timesteps_iter:
            ...
            model_output = self(
                ...
                low_res_input_ids=low_res_input_ids
            )
